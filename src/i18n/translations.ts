export const translations = {
  cs: {
    ...
    'analyses.hormuz-chart.title': 'Hormuz živě: denní transity',
    'analyses.hormuz-chart.desc': 'Kolik tankerů a kolik barelů prochází Hormuzem každý den od roku 2019. Plus paralelní pohled na Bab el-Mandéb, Suez a King Fahd Causeway.',
    'analyses.hormuz-chart.why': 'Když „Zavření brány" simuluje dopad přerušení, tady je vidět, co branami reálně proudilo a kdy se to zachvělo.',
    'analyses.hormuz-chart.cta': 'Otevřít dashboard',
  ...
  en: {
    ...
    'analyses.hormuz-chart.title': 'Hormuz Live: Daily Transits',
    'analyses.hormuz-chart.desc': 'How many tankers and how many barrels move through Hormuz every day since 2019. Plus a parallel view of Bab el-Mandeb, Suez and the King Fahd Causeway.',
    'analyses.hormuz-chart.why': 'When the Strait Closure simulator models disruption impact, this is the live record of what actually flowed through the gates and when it shook.',
    'analyses.hormuz-chart.cta': 'Open dashboard',
